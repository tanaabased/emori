...
- Added ordered Agent System setup for dependencies, shared plugins, and EMORI's agent-scoped tool policies. [#65](https://github.com/tanaabased/emori/issues/65)
