...
- Added the first repeatable Agent System setup steps for EMORI's Homebrew dependencies, Canon checkout, and Canon plugin. [#65](https://github.com/tanaabased/emori/issues/65)
