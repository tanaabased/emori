...
- Added ordered Agent System setup for Homebrew, Canon checkout and plugin skills, and the official Codex plugin. [#65](https://github.com/tanaabased/emori/issues/65)
