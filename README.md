...
The prefix also limits EMORI's message tool to sends while inheriting OpenClaw's
cross-provider routing and attribution defaults. Canon is cloned with EMORI's
